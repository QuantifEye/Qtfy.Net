...
{
    public static void TriangularMatrixMultiply<TMatrixViewA, TMatrixRowA, TMatrixColumnA, TMatrixViewB, TMatrixRowB, TMatrixColumnB>(
        Side side,
        Uplo uplo,
        Diag diag,
        TNumber alpha,
        ...
        where TMatrixColumnB : struct, IVectorView<TNumber>, allows ref struct
    {
        ...
        UnsafeBlas3.TriangularMatrixMultiply(
            side: side,
            uplo: uplo,
            diag: diag,
            rows: rows,

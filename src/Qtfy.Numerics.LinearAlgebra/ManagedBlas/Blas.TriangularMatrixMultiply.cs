...
{
    public static void TriangularMatrixMultiply<TMatrixViewA, TMatrixRowA, TMatrixColumnA, TMatrixViewB, TMatrixRowB, TMatrixColumnB, TSide, TUpperLower, TDiagonal>(
        TNumber alpha,
        TMatrixViewA matrix,
        TMatrixViewB b)
        ...
        where TDiagonal : Matrices.Traits.IDiagonal
    {
        ...
        UnsafeBlas.TriangularMatrixMultiply<TNumber, TSide, TUpperLower, TDiagonal>(
            rows: rows,
            columns: columns,
            alpha: alpha,

...
internal partial class BigRationalTests
{
    ...
    public void RationalToDecimalWithRounding(string rationalAsDecimal, string expected)
    {
        ...
        Assert.That(actual, Is.EqualTo(ParseDecimal(expected)));
    }
    ...
    public void CastToDoubleRounding(double expected, int shift)
    {
        ...
        Assert.That((double)new BigRational(two54 + shift, two54), Is.EqualTo(expected));
    }
    ...
    public void CastToDoubleRoundToInfinity()
    {
        ...
        Assert.That((double)toRound, Is.EqualTo(double.PositiveInfinity));
        Assert.That((double)-toRound, Is.EqualTo(double.NegativeInfinity));
    }
    ...
    {
        Assert.That(BitConverter.DoubleToInt64Bits(left), Is.EqualTo(BitConverter.DoubleToInt64Bits(right)));
    }

    private static void AssertBitEqual(float left, float right)
    {
        Assert.That(BitConverter.SingleToInt32Bits(left), Is.EqualTo(BitConverter.SingleToInt32Bits(right)));
    }
